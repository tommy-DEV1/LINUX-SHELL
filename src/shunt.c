...
#define ITEM_VAR_PTR 2
    ...
    {
        long val;
        struct symtabEntryStruct *ptr;
    };
};

struct operatorStruct *opstack[MAXOPSTACK];
int nopstack = 0;

struct stackItemStruct numstack[MAXNUMSTACK];
int nnumstack = 0;
int error = 0;

long longValue(struct stackItemStruct *a)
{
...
long evaluateMinus(struct stackItemStruct *a1, struct stackItemStruct *a2 __attribute__((unused)))
{
    return -longValue(a1);
}

long evaluatePlus(struct stackItemStruct *a1, struct stackItemStruct *a2 __attribute__((unused)))
{
    return longValue(a1);
}

long evaluateLognot(struct stackItemStruct *a1, struct stackItemStruct *a2 __attribute__((unused)))
{
    return !longValue(a1);
}

long evaluateBitnot(struct stackItemStruct *a1, struct stackItemStruct *a2 __attribute__((unused)))
{
    return ~longValue(a1);
}

long evaluateMultiplication(struct stackItemStruct *a1, struct stackItemStruct *a2)
{
    return longValue(a1) * longValue(a2);
}

long evaluateAddition(struct stackItemStruct *a1, struct stackItemStruct *a2)
{
    return longValue(a1) + longValue(a2);
}

long evaluateSubtraction(struct stackItemStruct *a1, struct stackItemStruct *a2)
{
    return longValue(a1) - longValue(a2);
}

long evaluateLSH(struct stackItemStruct *a1, struct stackItemStruct *a2)
{
    return longValue(a1) << longValue(a2);
}

long evaluateRSH(struct stackItemStruct *a1, struct stackItemStruct *a2)
{
    return longValue(a1) >> longValue(a2);
}

long eval_lt(struct stackItemStruct *a1, struct stackItemStruct *a2)
{
    return longValue(a1) < longValue(a2);
}

long eval_le(struct stackItemStruct *a1, struct stackItemStruct *a2)
{
    return longValue(a1) <= longValue(a2);
}

long eval_gt(struct stackItemStruct *a1, struct stackItemStruct *a2)
{
    return longValue(a1) > longValue(a2);
}

long eval_ge(struct stackItemStruct *a1, struct stackItemStruct *a2)
{
    return longValue(a1) >= longValue(a2);
}

long eval_eq(struct stackItemStruct *a1, struct stackItemStruct *a2)
{
    return longValue(a1) == longValue(a2);
}

long eval_ne(struct stackItemStruct *a1, struct stackItemStruct *a2)
{
    return longValue(a1) != longValue(a2);
}

long eval_bitand(struct stackItemStruct *a1, struct stackItemStruct *a2)
{
    return longValue(a1) & longValue(a2);
}

long eval_bitxor(struct stackItemStruct *a1, struct stackItemStruct *a2)
{
    return longValue(a1) ^ longValue(a2);
}

long eval_bitor(struct stackItemStruct *a1, struct stackItemStruct *a2)
{
    return longValue(a1) | longValue(a2);
}

long eval_logand(struct stackItemStruct *a1, struct stackItemStruct *a2)
{
    return longValue(a1) && longValue(a2);
}

long eval_logor(struct stackItemStruct *a1, struct stackItemStruct *a2)
{
    return longValue(a1) || longValue(a2);
}
...
long eval_exp(struct stackItemStruct *a1, struct stackItemStruct *a2)
{
    return do_eval_exp(longValue(a1), longValue(a2));
}

long eval_div(struct stackItemStruct *a1, struct stackItemStruct *a2)
{
    error = 0;
    long n2 = longValue(a2);
    if (!n2)
    {
    ...
    return longValue(a1) / n2;
}

long eval_mod(struct stackItemStruct *a1, struct stackItemStruct *a2)
{
    error = 0;
    long n2 = longValue(a2);
    if (!n2)
...
long eval_assign(struct stackItemStruct *a1, struct stackItemStruct *a2)
{
    long val = longValue(a2);
    if (a1->type == ITEM_VAR_PTR)
    {
        char buf[16];
        sprintf(buf, "%ld", val);
        symtabEntrySetValue(a1->ptr, buf);
    }
    return val;
}

long do_eval_assign_ext(long (*f)(struct stackItemStruct *a1, struct stackItemStruct *a2),
                        struct stackItemStruct *a1, struct stackItemStruct *a2)
{
    long val = f(a1, a2);
    if (a1->type == ITEM_VAR_PTR)
    {
...
long eval_assign_add(struct stackItemStruct *a1, struct stackItemStruct *a2)
{
    return do_eval_assign_ext(evaluateAddition, a1, a2);
}

long eval_assign_sub(struct stackItemStruct *a1, struct stackItemStruct *a2)
{
    return do_eval_assign_ext(evaluateSubtraction, a1, a2);
}

long eval_assign_mult(struct stackItemStruct *a1, struct stackItemStruct *a2)
{
    return do_eval_assign_ext(evaluateMultiplication, a1, a2);
}

long eval_assign_div(struct stackItemStruct *a1, struct stackItemStruct *a2)
{
    return do_eval_assign_ext(eval_div, a1, a2);
}

long eval_assign_mod(struct stackItemStruct *a1, struct stackItemStruct *a2)
{
    return do_eval_assign_ext(eval_mod, a1, a2);
}

long eval_assign_lsh(struct stackItemStruct *a1, struct stackItemStruct *a2)
{
    return do_eval_assign_ext(evaluateLSH, a1, a2);
}

long eval_assign_rsh(struct stackItemStruct *a1, struct stackItemStruct *a2)
{
    return do_eval_assign_ext(evaluateRSH, a1, a2);
}

long eval_assign_and(struct stackItemStruct *a1, struct stackItemStruct *a2)
{
    return do_eval_assign_ext(eval_bitand, a1, a2);
}

long eval_assign_xor(struct stackItemStruct *a1, struct stackItemStruct *a2)
{
    return do_eval_assign_ext(eval_bitxor, a1, a2);
}

long eval_assign_or(struct stackItemStruct *a1, struct stackItemStruct *a2)
{
    return do_eval_assign_ext(eval_bitor, a1, a2);
}

long do_eval_inc_dec(int pre, int add, struct stackItemStruct *a1)
{
    long val = longValue(a1);
    char buf[16];
    if (pre)
    {
        if (add)
...
long eval_postinc(struct stackItemStruct *a1, struct stackItemStruct *unused __attribute__((unused)))
{
    return do_eval_inc_dec(0, 1, a1);
}

long eval_postdec(struct stackItemStruct *a1, struct stackItemStruct *unused __attribute__((unused)))
{
    return do_eval_inc_dec(0, 0, a1);
}

long eval_preinc(struct stackItemStruct *a1, struct stackItemStruct *unused __attribute__((unused)))
{
    return do_eval_inc_dec(1, 1, a1);
}

long eval_predec(struct stackItemStruct *a1, struct stackItemStruct *unused __attribute__((unused)))
{
...
struct operatorStruct
{
    ...
    char unary;
    char chars;
    long (*eval)(struct stackItemStruct *a1, struct stackItemStruct *a2);
} arithm_ops[] =
    {
        ...
        {CH_MINUS, 19, ASSOC_RIGHT, 1, 1, evaluateMinus},
        {CH_PLUS, 19, ASSOC_RIGHT, 1, 1, evaluatePlus},
        {'!', 19, ASSOC_RIGHT, 1, 1, evaluateLognot},
        {'~', 19, ASSOC_RIGHT, 1, 1, evaluateBitnot},
        {CH_EXP, 18, ASSOC_RIGHT, 0, 2, eval_exp},
        {'*', 17, ASSOC_LEFT, 0, 1, evaluateMultiplication},
        {'/', 17, ASSOC_LEFT, 0, 1, eval_div},
        {'%', 17, ASSOC_LEFT, 0, 1, eval_mod},
        {'+', 16, ASSOC_LEFT, 0, 1, evaluateAddition},
        {'-', 16, ASSOC_LEFT, 0, 1, evaluateSubtraction},
        {CH_LSH, 15, ASSOC_LEFT, 0, 2, evaluateLSH},
        {CH_RSH, 15, ASSOC_LEFT, 0, 2, evaluateRSH},
...
struct operatorStruct *OP_POST_INC = &arithm_ops[0];
struct operatorStruct *OP_POST_DEC = &arithm_ops[1];
struct operatorStruct *OP_PRE_INC = &arithm_ops[2];
struct operatorStruct *OP_PRE_DEC = &arithm_ops[3];
struct operatorStruct *OP_UMINUS = &arithm_ops[4];
struct operatorStruct *OP_UPLUS = &arithm_ops[5];
struct operatorStruct *OP_LOG_NOT = &arithm_ops[6];
struct operatorStruct *OP_BIT_NOT = &arithm_ops[7];
struct operatorStruct *OP_EXP = &arithm_ops[8];
struct operatorStruct *OP_MULT = &arithm_ops[9];
struct operatorStruct *OP_DIV = &arithm_ops[10];
struct operatorStruct *OP_MOD = &arithm_ops[11];
struct operatorStruct *OP_ADD = &arithm_ops[12];
struct operatorStruct *OP_SUB = &arithm_ops[13];
struct operatorStruct *OP_LSH = &arithm_ops[14];
struct operatorStruct *OP_RSH = &arithm_ops[15];
struct operatorStruct *OP_LT = &arithm_ops[16];
struct operatorStruct *OP_LE = &arithm_ops[17];
struct operatorStruct *OP_GT = &arithm_ops[18];
struct operatorStruct *OP_GE = &arithm_ops[19];
struct operatorStruct *OP_EQ = &arithm_ops[20];
struct operatorStruct *OP_NE = &arithm_ops[21];
struct operatorStruct *OP_BIT_AND = &arithm_ops[22];
struct operatorStruct *OP_BIT_XOR = &arithm_ops[23];
struct operatorStruct *OP_BIT_OR = &arithm_ops[24];
struct operatorStruct *OP_LOG_AND = &arithm_ops[25];
struct operatorStruct *OP_LOG_OR = &arithm_ops[26];
struct operatorStruct *OP_ASSIGN = &arithm_ops[27];
struct operatorStruct *OP_ASSIGN_ADD = &arithm_ops[28];
struct operatorStruct *OP_ASSIGN_SUB = &arithm_ops[29];
struct operatorStruct *OP_ASSIGN_MULT = &arithm_ops[30];
struct operatorStruct *OP_ASSIGN_DIV = &arithm_ops[31];
struct operatorStruct *OP_ASSIGN_MOD = &arithm_ops[32];
struct operatorStruct *OP_ASSIGN_LSH = &arithm_ops[33];
struct operatorStruct *OP_ASSIGN_RSH = &arithm_ops[34];
struct operatorStruct *OP_ASSIGN_AND = &arithm_ops[35];
struct operatorStruct *OP_ASSIGN_XOR = &arithm_ops[36];
struct operatorStruct *OP_ASSIGN_OR = &arithm_ops[37];
struct operatorStruct *OP_LBRACE = &arithm_ops[38];
struct operatorStruct *OP_RBRACE = &arithm_ops[39];
 ...
 */
struct operatorStruct *get_op(char *expr)
{
    switch (*expr)
    {
    case '+':
 ...
 */
void push_opstack(struct operatorStruct *op)
{
 ...
 */
struct operatorStruct *pop_opstack(void)
{
    if (!nopstack)
    {
 ...
 */
void push_numstackv(struct symtabEntryStruct *val)
{
    if (nnumstack > MAXNUMSTACK - 1)
    {
        fprintf(stderr, "error: Number stack overflow\n");
 ...
 */
struct stackItemStruct pop_numstack(void)
{
    if (!nnumstack)
    {
        fprintf(stderr, "error: Number stack empty\n");
        error = 1;
        return (struct stackItemStruct){};
    }
 ...
 */
void shunt_op(struct operatorStruct *op)
{
    struct operatorStruct *pop;
    error = 0;
    if (op->op == '(')
    {
        push_opstack(op);
    ...
    else if (op->op == ')')
    {
        while (nopstack > 0 && opstack[nopstack - 1]->op != '(')
        {
            ...
            struct stackItemStruct n1 = pop_numstack();
            if (error)
            {
                return;
            }
            ...
            {
                struct stackItemStruct n2 = pop_numstack();
                if (error)
                {
                    return;
                }
 ...
 */
struct symtabEntryStruct *get_var(char *s, int *char_count)
{
    char *ss = s;
    if (*ss == '$')
    {
    ...
    struct symtabEntryStruct *e = getSymtabEntry(name);
    if (!e)
    {
        e = addToSymtab(name);
    }
...
char *arithmaticExpand(char *orig_expr)
{
    char *expr;
    char *tstart = NULL;
    struct operatorStruct startop = {'X', 0, ASSOC_NONE, 0, 0, NULL}; /* Dummy operator to mark start */
    struct operatorStruct *op = NULL;
    int n1, n2;
    struct operatorStruct *lastop = &startop;
    /*
    ...
    for (; *expr;)
    {
        ...
        else
        {
            ...
            {
                struct symtabEntryStruct *n1 = get_var(tstart, &n2);
                if (!n1)
                {
